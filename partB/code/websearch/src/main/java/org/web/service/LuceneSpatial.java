...
//                System.out.println(d);
    ...
    public List<lucenetest> searchBasic(String keyword) throws Exception {
        ...
        indexReader = IndexReader.open(indexDirectory, true);
        indexSearcher = new IndexSearcher(indexReader);
        Sort sort = new Sort(new SortField("text", SortField.SCORE), new SortField("date", SortField.LONG, true));
...
//            e.printStackTrace();
//        }
        String a = NumericUtils.doubleToPrefixCoded(-108);
        System.out.println(NumericUtils.prefixCodedToDouble(a));
        System.out.println(NumericUtils.doubleToPrefixCoded(-108.0));
    }
}